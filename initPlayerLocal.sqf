...
if (hasInterface) then
{
	...
	if (musicVolume < 0.3) exitWith {
		["Vous devez régler l'audio 'musique' à au moins 30% pour pouvoir vous connecter. Sans musique vous perdrez de l'immersion et risquez de rater les annonces de redémarrages du serveur."] spawn AlysiaClient_fnc_errorExit;
	};
