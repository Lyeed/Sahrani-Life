...
if (_veh getVariable ["refueling", false]) exitWith {["Remplissage de la station impossible.<br/>Quelqu'un est déjà en train d'utiliser le véhicule."] call AlysiaClient_fnc_error};
...
if (_station getVariable ["fuel_inUse", false]) exitWith {["Remplissage de la station impossible.<br/>Quelqu'un est déjà en train d'utiliser la station."] call AlysiaClient_fnc_error};
