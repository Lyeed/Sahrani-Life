...
(_display displayCtrl 16008) ctrlSetStructuredText parseText format ["<t align='center' size='2'>%1</t>", ([cursorTarget, (lbData [16004, lbCurSel 16004])] call public_fnc_fuelPrice)];
