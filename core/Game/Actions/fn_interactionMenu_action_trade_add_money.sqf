...
if ((g_interaction_trade_money + _val) > 999999) exitWith {[format["Vous ne pouvez pas donner plus de %1kn", [999999] call AlysiaClient_fnc_numberText]] call AlysiaClient_fnc_error};
