...
[
	...
	[
		["identity", "Carte d'identité", "[g_interaction_target] spawn public_fnc_showIdentity; closeDialog 0;", "((getText(missionConfigFile >> 'ALYSIA_FACTIONS' >> str(playerSide) >> 'identity_item') isEqualTo '') || (getText(missionConfigFile >> 'ALYSIA_FACTIONS' >> str(playerSide) >> 'identity_item') in (magazines player)))"],
		...
		["morphine", "Morphine", "[nil,nil,nil,g_interaction_target] spawn public_fnc_item_morphine_use;", "(""SkylineItems_Morphine"" in (magazines player))"],
