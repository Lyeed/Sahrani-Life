...
[
	...
	[
		...
		["arrest", "Arrêter", "[g_interaction_target] spawn public_fnc_prisonArrest", "(((player distance prison_n < 10) || (player distance prison_s < 10)) && (!(g_interaction_target getVariable['restrained', false])) && (!(player getVariable ['arrested', false])))"],
		["arrest", "Gestion Peine", "[g_interaction_target] spawn public_fnc_interactions_player_to_player_prison;", "(((player distance prison_n < 10) || (player distance prison_s < 10)) && (!(g_interaction_target getVariable['restrained', false])) && (player getVariable ['arrested', false]))"],
