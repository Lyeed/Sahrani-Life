...
if (_importPrice > g_atm) exitWith {
	[format["Il vous faut <t color='#ff8c8c'>%1$</t> pour rapatrier ce véhicule", [_importPrice] call public_fnc_numberText]] call public_fnc_error;
};

_vehicleName = lbText[2802, _sel];
_action = 
[
	format["Voulez-rapatrier votre <t color='#FF8000'>%1</t> pour <t color='#8cff9b'>%2$</t>", _vehicleName, ([_importPrice] call public_fnc_numberText)],
	"Rapatriement",
	"Valider",
	"Annuler"
