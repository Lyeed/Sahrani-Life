...
[
	...
	if (_storage isEqualTo "") then {"<t color='#ff8c8c'>Non</t>"} else {format["<t color='#8cff9b'>Oui</t>, %1", ([getText(missionConfigFile >> "ALYSIA_STORAGES" >> _storage >> "item")] call public_fnc_itemGetName)]},
