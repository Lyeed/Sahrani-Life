...
[format["Vous avez acheté les coordonnées de <t color='#74DF00'>%1</t> pour <t color='#8cff9b'>%2</t>kn", (markerText _marker), ([_price] call AlysiaClient_fnc_numberText)], "buy"] call AlysiaClient_fnc_info;
