...
if (_selection == -1) exitWith { [(localize "STR_Shop_NoSelection")] call ALYSIA_fnc_error; };
if (isNull _control) exitWith { [(localize "STR_Shop_NoDisplay")] call ALYSIA_fnc_error; };
