...
*/
private["_unit", "_bed", "_search_reader"];
...
_bed = (nearestObjects [_unit, ["HospitalTable_F", "HospitalBed_F", "HealTable_F", "Siuuz_Brancard_01_F"], 6]) select 0;
...
_search_reader = switch (typeOf(_bed)) do
{
	case "Siuuz_Brancard_01_F":
	{
