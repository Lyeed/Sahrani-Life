...
(_dialog displayCtrl 7603) ctrlSetStructuredText parseText format["<t align='center' color='#8cff9b' size='1.2'>%1</t><t align='right'>$</t>", ([g_atm] call public_fnc_numberText)];
(_dialog displayCtrl 7606) ctrlSetStructuredText parseText format["<t align='center' color='#8cff9b'>%1</t><t align='right'>$</t>", ([(call g_paycheck)] call public_fnc_numberText)];
