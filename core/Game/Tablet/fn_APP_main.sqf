...
[
	...
	["lyeed_IMG\data\tablet\app_main\app_dab.paa", "lyeed_IMG\data\tablet\app_main\app_dab_select.paa", "['DAB'] spawn AlysiaClient_fnc_tabletApp;", "Distributeurs", "'DAB' in g_apps"]
];
