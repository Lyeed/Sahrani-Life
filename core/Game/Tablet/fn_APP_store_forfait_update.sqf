...
(_display displayCtrl 8139) ctrlSetStructuredText parseText format["<t align='center' color='#8cff9b'>%1</t><t align='right'>$</t>", [getNumber(missionConfigFile >> "ALYSIA_FORFAITS" >> _forfait >> "bill")] call public_fnc_numberText];
(_display displayCtrl 8141) ctrlSetStructuredText parseText format["<t align='center' color='#8cff9b'>%1</t><t align='right'>$</t>", [getNumber(missionConfigFile >> "ALYSIA_FORFAITS" >> _forfait >> "sms_price")] call public_fnc_numberText];
