...
(_display displayCtrl 8137) ctrlSetStructuredText parseText format
[
	"<t align='center'>%1</t>",
	(_list lbText _index)
];

(_display displayCtrl 8139) ctrlSetStructuredText parseText format
[
...
(_display displayCtrl 8141) ctrlSetStructuredText parseText format
[
	"<t align='center' color='#8cff9b'>%1</t><t align='right'>kn</t>",
	[getNumber(missionConfigFile >> "ALYSIA_PHONE" >> "FORFAITS" >> _forfait >> "sms_price")] call public_fnc_numberText
];

(_display displayCtrl 8144) ctrlSetStructuredText parseText format
[
	"%1",
	getNumber(missionConfigFile >> "ALYSIA_PHONE" >> "FORFAITS" >> _forfait >> "sms_max")
];

(_display displayCtrl 8146) ctrlSetStructuredText parseText format
[
	"%1",
	getNumber(missionConfigFile >> "ALYSIA_PHONE" >> "FORFAITS" >> _forfait >> "contacts_max")
];

(_display displayCtrl 8148) ctrlSetStructuredText parseText format
[
	"%1",
