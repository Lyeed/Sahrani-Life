class RscDisplayShopDynMarkers: default_interaction_back_dialog
{
	...
	class controls: DEFAULT_controls
	{
		...
		class ACTION_BUY_BUTTON: RscButtonSilent
		{
			...
			onMouseEnter = "			ctrlSetText[21008,""lyeed_IMG\data\global\action_buy_select.paa""];			ctrlShow[21006, false];			((findDisplay 21000) displayCtrl 21005) ctrlSetBackgroundColor [1,1,1,1];			((findDisplay 21000) displayCtrl 21007) ctrlSetStructuredText parseText ""<t align='left' size='1.3' color='#000000'>Acheter</t>"";";
			onMouseExit = "			ctrlSetText[21008,""lyeed_IMG\data\global\action_buy.paa""];			if (ctrlVisible 21008) then {				ctrlShow[21006, true];			};			((findDisplay 21000) displayCtrl 21005) ctrlSetBackgroundColor [0,0,0,0.6];			((findDisplay 21000) displayCtrl 21007) ctrlSetStructuredText parseText ""<t align='left' size='1.3' color='#FFFFFF'>Acheter</t>"";";
