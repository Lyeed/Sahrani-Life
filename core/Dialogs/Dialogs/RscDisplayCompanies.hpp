class RscDisplayCompanyCreate: default_interaction_back_dialog
{
	idd = 90000;
...
class RscDisplayCompanyConstruction: default_interaction_back_dialog
{
	idd = 91000;
...
class RscDisplayCompanyInfo: default_interaction_back_dialog
{
	idd = 92000;
