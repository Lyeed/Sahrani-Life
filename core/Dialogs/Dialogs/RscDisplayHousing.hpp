class RscDisplayHousingBuy: default_base_dialog
{
	...
	class controls
	{
		...
		class ACTION_BUY_BUTTON: RscButtonSilent
		{
			...
			onMouseEnter = "			ctrlSetText[45007,""lyeed_IMG\data\housing\actions\action_buy_select.paa""];			ctrlShow[45002, false];			((findDisplay 45000) displayCtrl 45001) ctrlSetBackgroundColor [1,1,1,1];			((findDisplay 45000) displayCtrl 45010) ctrlSetStructuredText parseText ""<t align='left' size='1.3' color='#000000'>Acheter</t>"";";
			onMouseExit = "			ctrlSetText[45007,""lyeed_IMG\data\housing\actions\action_buy.paa""];			ctrlShow[45002, true];			((findDisplay 45000) displayCtrl 45001) ctrlSetBackgroundColor [0,0,0,0.6];			((findDisplay 45000) displayCtrl 45010) ctrlSetStructuredText parseText ""<t align='left' size='1.3' color='#FFFFFF'>Acheter</t>"";";
		...
		class ACTION_EXIT_BUTTON: RscButtonSilent
		{
			...
			onMouseEnter = "			ctrlSetText[45011,""lyeed_IMG\data\housing\actions\action_exit_select.paa""];			ctrlShow[45013, false];			((findDisplay 45000) displayCtrl 45014) ctrlSetBackgroundColor [1,1,1,1];			((findDisplay 45000) displayCtrl 45012) ctrlSetStructuredText parseText ""<t align='left' size='1.3' color='#000000'>Quitter</t>"";";
			onMouseExit = "			ctrlSetText[45011,""lyeed_IMG\data\housing\actions\action_exit.paa""];			ctrlShow[45013, true];			((findDisplay 45000) displayCtrl 45014) ctrlSetBackgroundColor [0,0,0,0.6];			((findDisplay 45000) displayCtrl 45012) ctrlSetStructuredText parseText ""<t align='left' size='1.3' color='#FFFFFF'>Quitter</t>"";";
