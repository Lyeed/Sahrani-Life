...
FACTION_BACKGROUND = "lyeed_IMG\data\tablet\backgrounds\back.jpg";
FACTION_IDCS[] = 
{
...
class FACTION_OFFICE_BUTTON: RscButtonMenu_colored
{
...
FACTION_LEADER_OFFICE_BACKGROUND = "lyeed_IMG\data\tablet\backgrounds\back.jpg";
...
class FACTION_LEADER_OFFICE_CIVILIAN_INVITE: RscButtonMenu_colored
{
...
class FACTION_LEADER_OFFICE_FACTION_EDIT: RscEdit
{
...
class FACTION_LEADER_OFFICE_FACTION_ACTION: RscButtonMenu_colored
{
...
class FACTION_LEADER_OFFICE_FACTION_HISTORY: RscButtonMenu_colored
{
...
FACTION_LEADER_HISTORY_BACKGROUND = "lyeed_IMG\data\tablet\backgrounds\back.jpg";
...
class FACTION_LEADER_HISTORY_DELETEALL: RscButtonMenu_colored
{
