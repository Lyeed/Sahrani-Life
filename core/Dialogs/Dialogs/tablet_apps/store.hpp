...
STORE_BACKGROUND = "lyeed_IMG\data\tablet\store\background.jpg";
STORE_IDCS[] =
{
...
class STORE_ACTION_IMAGE: RscPicture
{
	...
	text = "lyeed_IMG\data\tablet\store\action_buy.paa";
...
class STORE_ACTION_BUTTON: RscButtonSilent
{
	...
	onMouseEnter = "ctrlSetText[(ctrlIDC (_this select 0)) - 1, ""lyeed_IMG\data\tablet\store\action_buy_select.paa""];";
	onMouseExit = "ctrlSetText[(ctrlIDC (_this select 0)) - 1, ""lyeed_IMG\data\tablet\store\action_buy.paa""];";
	tooltip = "Acheter";
...
//Licences
STORE_LICENSES_BACKGROUND = "lyeed_IMG\data\tablet\store\background.jpg";
STORE_LICENSES_IDCS[] =
{
...
//Applications
STORE_APPLICATIONS_BACKGROUND = "lyeed_IMG\data\tablet\store\background.jpg";
...
//Forfaits
STORE_FORFAIT_BACKGROUND = "lyeed_IMG\data\tablet\store\background.jpg";
STORE_FORFAIT_IDCS[] =
{
	STORE_BACK_IMAGE_IDC,
	STORE_BACK_BUTTON_IDC,
