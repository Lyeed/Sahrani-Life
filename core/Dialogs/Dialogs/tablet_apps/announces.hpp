...
class ANNOUNCES_CATEGORY_SHOW_IMAGE: RscPicture
{
	...
	text = "lyeed_IMG\data\tablet\announces\action_announces_show.paa";
...
class ANNOUNCES_CATEGORY_SHOW_BUTTON: RscButtonSilent
{
	...
	action = "['ANNOUNCES_SHOW'] spawn public_fnc_tabletApp;";
	onMouseEnter = "ctrlSetText[9501,""lyeed_IMG\data\tablet\announces\action_announces_show_select.paa""];";
	onMouseExit = "ctrlSetText[9501,""lyeed_IMG\data\tablet\announces\action_announces_show.paa""];";
...
class ANNOUNCES_CATEGORY_WRITE_IMAGE: RscPicture
{
	...
	text = "lyeed_IMG\data\tablet\announces\action_announces_write.paa";
...
class ANNOUNCES_CATEGORY_WRITE_BUTTON: RscButtonSilent
{
	...
	action = "['ANNOUNCES_WRITE'] spawn public_fnc_tabletApp;";
	onMouseEnter = "ctrlSetText[9504,""lyeed_IMG\data\tablet\announces\action_announces_write_select.paa""];";
	onMouseExit = "ctrlSetText[9504,""lyeed_IMG\data\tablet\announces\action_announces_write.paa""];";
...
class ANNOUNCES_BACK_BUTTON: RscButtonSilent
{
	...
	action = "['ANNOUNCES'] spawn public_fnc_tabletApp;";
...
ANNOUNCES_WRITE_BACKGROUND = "lyeed_IMG\data\tablet\backgrounds\back_announces.jpg";
...
class ANNOUNCES_WRITE_ACTION_BUTTON: RscButtonSilent
{
	...
	action = "[] call public_fnc_APP_announces_write_action;";
	onMouseEnter = "ctrlSetText[(ctrlIDC (_this select 0)) - 1,""lyeed_IMG\data\tablet\announces\action_announces_write_select.paa""];";
	onMouseExit = "ctrlSetText[(ctrlIDC (_this select 0)) - 1,""lyeed_IMG\data\tablet\announces\action_announces_write.paa""];";
...
ANNOUNCES_SHOW_BACKGROUND = "lyeed_IMG\data\tablet\backgrounds\back_announces.jpg";
ANNOUNCES_SHOW_IDCS[] = 
{
	ANNOUNCES_BACK_IMAGE_IDC,
	ANNOUNCES_BACK_BUTTON_IDC,
...
class ANNOUNCES_SHOW_LIST: RscListbox
{
	...
	onLBSelChanged = "_this call public_fnc_APP_announces_show_update;";
