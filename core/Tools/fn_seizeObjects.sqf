...
if (g_firstCombatActive) exitWith {["Vous ne pouvez pas saisir alors que vous êtes en combat"] call AlysiaClient_fnc_error};

_objects = nearestObjects [player, ["weaponholder","GroundWeaponHolder","WeaponHolderSimulated","Land_Suitcase_F"], _distance];
