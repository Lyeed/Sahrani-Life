class RscDisplayVirtualReduce: RscDisplayDefaultInteraction
{
	...
	class controls: DEFAULT_controls
	{
		...
		{
			idc = 91003;
			text = "lyeed_IMG\data\virtual_reduce\arrow_left.paa";
		...
		class ACTION_BUTTON: RscButtonSilent
		{
			...
			onMouseEnter = "ctrlSetText[91003,""lyeed_IMG\data\virtual_reduce\arrow_left_select.paa""];";
			onMouseExit = "ctrlSetText[91003,""lyeed_IMG\data\virtual_reduce\arrow_left.paa""];";
