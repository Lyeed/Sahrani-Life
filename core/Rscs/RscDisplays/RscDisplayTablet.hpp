class RscDisplayTablet: RscDisplayDefault
{
	...
	class controlsBackground
	{
		...
		{
			text = "lyeed_IMG\data\tablet\frame.paa";
		...
		{
			idc = 7502;
			text = "lyeed_IMG\data\tablet\backgrounds\loading_screen.jpg";
	...
	class controls
	{
		...
		{
			idc = 7507;
			text = "lyeed_IMG\data\tablet\home_basic.paa";
		...
		{
			action = "uiNamespace setVariable[""main_status"", 0]; [""MAIN""] spawn AlysiaClient_fnc_tabletApp;";
