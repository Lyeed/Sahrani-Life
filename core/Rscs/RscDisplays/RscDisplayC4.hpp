class RscDisplayC4: RscDisplayDefault
{
	...
	class controlsBackground
	{
		...
		{
			text = "lyeed_IMG\data\c4\bomb.paa";
	...
	class controls
	{
		...
		{
			idc = 12005;
			text = "lyeed_IMG\data\c4\middle.paa";
		...
		class BUTTON_VALIDATE: RscButtonSilent
		{
			...
			soundClick[] = {"lyeed_Sounds\data\c4_validate.ogg",0.09 ,1};
		...
		class BUTTON_UP: RscButtonSilent
		{
			...
			soundClick[] = {"lyeed_Sounds\data\c4_bip.ogg",0.09 ,1};
