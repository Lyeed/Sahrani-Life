class ALYSIA_PROCESS
{
	...
	**************                         *******************/
	class weapon_ak_1
	{
		name="Arme : AK74 (1)";
		sound="smelting";
		require[]={{"canon",1},{"crosse_wood",1},{"garde_main_wood",1},{"poignee",1},{"detente",1},{"percuteur",1}};
	...
	{
		name="Arme : Mosin";
		require[]={{"canon",1},{"crosse_wood",1},{"garde_main_wood",1},{"detente",1},{"percuteur",1},{"culasse",1}};
	...
	class weapon_sawed: weapon_ak_1
	{
		...
		require[]={{"canon",2},{"crosse_wood",1},{"detente",1},{"percuteur",1}};
	...
	class weapon_tec: weapon_ak_1
	{
		...
		require[]={{"canon",1},{"poignee",1},{"detente",1},{"percuteur",1},{"carcasse",1},{"bloc_culasse",1}};
		receive[]={{},{"RH_tec9"},0};
		time_per_item=15;
		class target {};
		class factions: factions {};
	...
	{
		name="Arme : Deagle";
		require[]={{"canon",1},{"poignee",1},{"detente",1},{"marteau",1},{"barillet",1}};
		receive[]={{},{"RH_deagle"},0};
		time_per_item=20;
		class target {};
		class factions: factions {};
	...
	class weapon_deagle_gold: weapon_deagle_normal
	{
		...
		require[]={{"canon",1},{"poignee",1},{"detente",1},{"marteau",1},{"barillet",1},{"goldbar",1}};
	...
	**************                        *******************/
	class weapon_b95
	{
		name="Arme : Fusil B95";
		sound="smelting";
		require[]={{"canon",2},{"crosse_wood",1},{"garde_main_wood",1},{"detente",1},{"percuteur",2}};
	...
	class weapon_cz75: weapon_b95
	{
		...
		require[]={{"canon",1},{"poignee",1},{"detente",1},{"percuteur",1},{"carcasse",1},{"bloc_culasse",1},{"marteau",1}};
		receive[]={{},{"RH_cz75"},0};
		time_per_item=30;
		class factions: factions {};
	};
	...
	{
		name="Arme : SDAR";
		require[]={{"canon",1},{"crosse_steel",1},{"garde_main_steel",1},{"poignee",1},{"detente",1},{"percuteur",1}};
		receive[]={{},{"Fett_SDAR"},0};
		time_per_item=30;
		class factions: factions {};
	};
